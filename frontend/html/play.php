...
<div class = "panel2">
  ...
  <form method="post" action="play-sticky.php">
   	...
   	<div class="input-group">
  		<label>Player 1:</label>
  		<input type="text" name="ePlayer1" value="" readonly>
        
  		</div> 
     	<div class="input-group">
                <label>Player 2:</label>
                <input type="text" name="ePlayer2" value="" readonly>
        
        	</div> 
	<div class="input-group">
                <label>Player 3:</label>
                <input type="text" name="ePlayer3" value="" readonly>
        
        	</div> 
	<div class="input-group">
                <label>Player 4:</label>
                <input type="text" name="ePlayer4" value="" readonly>
        
        	</div> 
	<div class="input-group">
                <label>Player 5:</label>
                <input type="text" name="ePlayer5" value="" readonly>
        	</div> 
	<div class="input-group">
